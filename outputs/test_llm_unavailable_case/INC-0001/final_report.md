...
| Created At | 2026-06-02T21:10:18+08:00 |
| Report Status | ready_for_analyst_review |
| Validation Status | passed |
| Generation Mode | deterministic_only |
| LLM Used | False |
| LLM Status | llm_failed_fallback_used: No module named 'langchain_community' |
| LLM Quality Status | failed_fallback_used |
| LLM Quality Issues | No module named 'langchain_community' |
| RAG Used | True |
